...
const Home1 = () => (
  <div class="lg:container lg:mx-auto max-w-full  justify-center  py-10 px-12 container bg-blue-500">
            <div class="text-6xl  text-center font-semibold text-white leading-none">Invierte en propiedades en un click.</div>
  ...
  <div class=" relative inline-block text-left dropdown">
    <span class="rounded-md shadow-sm"><button class="inline-flex justify-center w-full px-4 py-2 text-sm font-medium leading-5 text-gray-700 transition duration-150 ease-in-out bg-white border border-gray-300 rounded-md hover:text-gray-500 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-50 active:text-gray-800" type="button" aria-haspopup="true" aria-expanded="true" aria-controls="headlessui-menu-items-117">
        <span>¿en que quieres invertir hoy?</span>
      ...
      <div class="absolute right-0 w-56 mt-2 origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none" aria-labelledby="headlessui-menu-button-1" id="headlessui-menu-items-117" role="menu">
        ...
        <div class="py-1">
          <a href="javascript:void(0)" tabindex="3" class="text-gray-700 flex justify-between w-full px-4 py-2 text-sm leading-5 text-left" role="menuitem">Sign out</a></div>
            ...
            <button class="mt-6 rounded-md  font-normal tracking-wide bg-trasparent hover:bg-blue-500 text-white  hover:text-white py-2 px-4 border border-white focus:text-red-600 max-h-screen w-64   transition duration-200 ease-in-out">
              Buscar
            </button>
            </div>
          </div>
